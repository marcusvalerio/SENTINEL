...
| `GITHUB_TOKEN` | Opcional. Token somente leitura para verificar repositórios privados. |
...
src/
  ...
  server/
    ...
    notes/ tools/ timeline/ github/   actions de cada módulo
  components/
...
## Fora deste ciclo (a arquitetura já prevê)

Sync completo do GitHub, roadmap, tarefas, documentação, tecnologia/stack, ledger financeiro, gestão de equipe na interface, Markdown/anexos/menções na Rubrica e múltiplos usuários na interface.
